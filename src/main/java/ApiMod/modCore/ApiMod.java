...
public class ApiMod implements EditCardsSubscriber, EditStringsSubscriber, EditCharactersSubscriber, EditKeywordsSubscriber {
    ...
    // 人物选择界面的立绘
    private static final String MY_CHARACTER_PORTRAIT = ModHelper.makePath("img/charSelect/a_pi.jpg");
    // 攻击牌的背景（小尺寸）
    private static final String BG_ATTACK_512 = ModHelper.makePath("img/512/bg_attack_MRS_s.png");
    // 能力牌的背景（小尺寸）
    private static final String BG_POWER_512 = ModHelper.makePath("img/512/bg_power_MRS_s.png");
    // 技能牌的背景（小尺寸）
    private static final String BG_SKILL_512 = ModHelper.makePath("img/512/bg_skill_MRS_s.png");
    // 在卡牌和遗物描述中的能量图标
    private static final String SMALL_ORB = ModHelper.makePath("img/512/cardOrb.png");
    // 攻击牌的背景（大尺寸）
    private static final String BG_ATTACK_1024 = ModHelper.makePath("img/1024/bg_attack_MRS.png");
    // 能力牌的背景（大尺寸）
    private static final String BG_POWER_1024 = ModHelper.makePath("img/1024/bg_power_MRS.png");
    // 技能牌的背景（大尺寸）
    private static final String BG_SKILL_1024 = ModHelper.makePath("img/1024/bg_skill_MRS.png");
    // 在卡牌预览界面的能量图标
    private static final String BIG_ORB = ModHelper.makePath("img/1024/cardOrb.png");
    // 小尺寸的能量图标（战斗中，牌堆预览）
    private static final String ENERGY_ORB = ModHelper.makePath("img/UI/energyOrb.png");
    //人物颜色
